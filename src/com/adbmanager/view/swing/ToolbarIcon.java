...
public class ToolbarIcon implements Icon {
    ...
    public enum Type {
        ...
        SYSTEM("M8 4L6.5 2.5 7.4 1.6 9.2 3.4H14.8L16.6 1.6 17.5 2.5 16 4H18V9H6V4H8z M9 6H10V7H9z M14 6H15V7H14z M5 10H6V17H5z M18 10H19V17H18z M6 10H18V17C18 18.1 17.1 19 16 19H15V22H13V19H11V22H9V19H8C6.9 19 6 18.1 6 17V10z"),
